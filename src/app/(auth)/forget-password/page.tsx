...
const page = () => {
    return (
        <div className="bg-background-light dark:bg-background-dark font-display text-[#0c1d1d] dark:text-gray-100 min-h-screen flex flex-col transition-colors duration-300">
            <header
                ...
                <div className="w-full max-w-110">
                    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl shadow-primary/5 p-8 md:p-12">
                        <div className="text-center mb-10">
                            ...
                            <h2 className="text-2xl font-extrabold tracking-tight mb-3 text-gray-900 dark:text-white">Reset Password
                            </h2>
